...
const ColorSchemeTool: React.FC = () => {
    ...
    // Export CSS variables to clipboard
        ...
        >
            ...
            <span className="font-medium">
              {activeColorKey.replace(/([A-Z])/g, ' $1').trim()}
                    ...
                    >
            <span className="bg-white bg-opacity-80 px-2 py-1 rounded text-sm font-mono">
            ...
            <div className="p-3 border-t border-gray-100 flex justify-between">
                <button
                    onClick={handleReset}
                    className="px-3 py-1 bg-gray-200 rounded text-gray-800 hover:bg-gray-300 transition-colors"
                    type="button"
                >
                    Reset
                </button>
                <button
                    ...
                    className="px-3 py-1 rounded text-white hover:opacity-90 transition-opacity"
                    style={{backgroundColor: colors.primaryColor}}
                    type="button"
                >
                    Export CSS
